...
export function HelpPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="w-full h-full sm:w-auto sm:h-auto sm:max-w-3xl sm:max-h-[90vh] sm:mx-4 bg-white dark:bg-[#242124] sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col sm:border border-[#E5E1E6] dark:border-[#534952]"
      ...
      >
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex gap-2 items-center shrink-0">
              <a
                ...
                onClick={() => trackEvent('outbound-link', { url: 'docs.yarnspinner.dev', location: 'help-panel' })}
              >
                Docs
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4 space-y-1 pb-[calc(1rem+env(safe-area-inset-bottom))]">
